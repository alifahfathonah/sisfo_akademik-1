<div class="container-fluid">
  ...
  <div class="alert alert-success" role="alert">
    ...
    <p>Selamat Datang <strong><?php echo $username; ?></strong> di Sistem Informasi Akademik Politeknik Harapan Bersama, Anda Login sebagai <strong><?php echo $level; ?></strong></p>
    <hr>
