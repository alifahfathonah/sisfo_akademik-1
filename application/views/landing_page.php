...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="<?php echo base_url('assets/img/campus.jpg') ?>" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="<?php echo base_url('assets/img/life.jpg') ?>" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="<?php echo base_url('assets/img/sport.jpg') ?>" class="d-block w-100" alt="...">
    </div>
  </div>
...
<div class="card text-center m-5">
  ...
  <div class="card-body">
    <p class="card-text">
      ...
      <?php echo word_limiter($ttg->sejarah, 15) ?>
      <?php endforeach; ?>
    </p>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <strong>Sejarah Politeknik Harapan Bersama</strong>
      <?php foreach($tentang as $ttg) : ?>
      <?php echo $ttg->sejarah ?>
      <?php endforeach; ?><br><br>

      <strong>Visi Politeknik Harapan Bersama</strong>
      <?php foreach($tentang as $ttg) : ?>
      <?php echo $ttg->visi ?>
      <?php endforeach; ?><br><br>

      <strong>Misi Politeknik Harapan Bersama</strong>
      <?php foreach($tentang as $ttg) : ?>
      <?php echo $ttg->misi ?>
      <?php endforeach; ?>
...
<div class="row m-5">
  ...
  <span class="display-4 text-center text-info mt-3"><i class="<?php echo $info->icon ?>"></i></span>
  <div class="card-body">
    <h5 class="card-title text-center text-dark"><?php echo $info->judul_informasi ?></h5>
